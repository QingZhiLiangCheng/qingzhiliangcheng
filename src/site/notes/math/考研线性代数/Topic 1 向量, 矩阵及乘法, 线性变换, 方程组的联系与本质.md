---
{"created":"2025-12-01T10:04","updated":"2026-05-15T17:19","dg-publish":true,"permalink":"/math/考研线性代数/Topic 1 向量, 矩阵及乘法, 线性变换, 方程组的联系与本质/","dgPassFrontmatter":true,"noteIcon":"","dg-note-properties":{"created":"2025-12-01T10:04","updated":"2026-05-15T17:19"}}
---
...
$$
#### 理解4：一种表格
![Pasted image 20260512094625.png\|300](/img/user/accessory/Pasted%20image%2020260512094625.png)
比如三个公司生成燃油 柴油 汽油这样子的表格

### 矩阵运算
矩阵的运算主要有 加法 数乘 乘法 转置 求逆 求行列式这么几种
加法满足交换律和结合律
数乘：$k(mA)=(km)A=m(kA);(k+m)A=kA+mA; k(A+B)=kA+kB$
乘法：$(AB)C=A(BC);A(B+C)=AB+AC;(B+C)A=BA+CA$
转置和求逆见[[math/考研线性代数/Topic 4 逆矩阵 转置 对称 初等矩阵 置换 行阶梯 行最简 分块矩阵\|Topic 4 逆矩阵 转置 对称 初等矩阵 置换 行阶梯 行最简 分块矩阵]]

值得注意的是
![Pasted image 20260512100131.png\|400](/img/user/accessory/Pasted%20image%2020260512100131.png)

![Pasted image 20260512100148.png\|400](/img/user/accessory/Pasted%20image%2020260512100148.png)

![Pasted image 20260512100216.png\|400](/img/user/accessory/Pasted%20image%2020260512100216.png)
...
$$
而三个一行成一列叠加在一起，就是C矩阵
![Pasted image 20260512100524.png\|400](/img/user/accessory/Pasted%20image%2020260512100524.png)
注意$α^Tβ$算出来的数刚好是$β^Tα$这个矩阵的迹，即主对角线之和

一列乘一行的n次方 要立马想到 中间一定存在一行乘一列的这样的n-1个数！
...
对于一个多项式可以写成一个矩阵
$$\begin{align}
&x_1^2+5x_2^2-4x_1x_2\\
&=x_1^2-2x_1x_2+5x^2-2x_1x_2\\
&=x_1(x_1-2x_2)+x_2(5x_2-2x_3)\\
&=\begin{bmatrix}x_1 & x_2\end{bmatrix}\begin{bmatrix}x_1-2x_2\\ -2x_1+5x_2\end{bmatrix}\\
&=\begin{bmatrix}x_1 & x_2\end{bmatrix}\begin{bmatrix}1&-2\\ -2&5\end{bmatrix}\begin{bmatrix}x_1\\ x_2\end{bmatrix}\\
&=x^TAx
\end{align}$$
A是一个对称矩阵 叫做二次型矩阵
这个A矩阵的规律是，平方项挨着写在主队线上 $-4x_1x_2$的系数-4 倍2除 放在1,2 和 2,1 的位置
能满足$x_1^2+5x_2^2-4x_1x_2$的矩阵A并不唯一 
![Pasted image 20260512101653.png\|400](/img/user/accessory/Pasted%20image%2020260512101653.png)
![Pasted image 20260512101703.png\|200](/img/user/accessory/Pasted%20image%2020260512101703.png)
...

#### 理解8：例子
![Pasted image 20260512100013.png\|500](/img/user/accessory/Pasted%20image%2020260512100013.png)
a到c的出行路径种数