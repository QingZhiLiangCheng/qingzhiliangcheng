---
{"created":"2025-11-05T17:20","updated":"2026-03-24T14:08","dg-publish":true,"permalink":"/Computer Networking A Top-Down Approach/2.4 Email/","dgPassFrontmatter":true,"noteIcon":"","dg-note-properties":{"created":"2025-11-05T17:20","updated":"2026-03-24T14:08"}}
---
...
有什么好处？ -- 抓包之后能看得懂
规定了报文必须为7位ASCII码的形式 -- 即它规定了所有的发送的命令和响应的内容以及邮件本身必须在7位ASCII码字符描述的范围之内，换句话说，就是规定了传输的内容必须是ASCII能表示出来
...
> 整个连接要关闭用QUIT
> 
> 值得注意的是，按照书中的说法，如果你用的网页版的用户代理，将邮件发往邮件服务器也可以用HTTP，如上图。用客户端的话，是SMTP
