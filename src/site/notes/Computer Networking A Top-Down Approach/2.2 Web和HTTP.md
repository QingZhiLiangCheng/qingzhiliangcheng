---
{"created":"2025-10-18T15:16","updated":"2026-07-20T09:43","dg-publish":true,"permalink":"/Computer Networking A Top-Down Approach/2.2 Web和HTTP/","dgPassFrontmatter":true,"noteIcon":"","dg-note-properties":{"created":"2025-10-18T15:16","updated":"2026-07-20T09:43"}}
---
...
### Web应用
Web是一个应用
Web页是由一些对象组成的，这些对象可以是HTML文件，可以是JPG图片，可以是音频文件等等，但是这些对象不是以对象自己的形式存在的，而是通过URL(统一资源定位符)对每个对象进行引用，URL包括访问协议，用户名，口令字，端口，目标文件等
...
客户端和浏览器之间首先要建立起TCP的连接，在这个链接之上发送HTTP请求；服务器在接收到HTTP请求之后，把客户端请 求的对象，封装成HTTP响应的报文，回转回客户端
HTTP是跑在TCP上，服务器在某个固定ip的80号端口上运行，服务器会创建一个监听socket绑定到IP和端口，等待来自客户端的tcp连接建立请求，一旦同意建立连接(怎么建立的，怎么同意建立的和TCP有关)，web服务器就会建立一个新的socket指向和客户端(浏览器)的会话关系
...
第一步是建立连接，在建立连接的时候，事实上应用程序要借助SocketAPI告诉下面的TCP要连接了，事实上客户端TCP实体会给服务端TCP实体发送一个连接请求的段，服务器的TCP实体收到段之后要往上传，服务器要同意，然后再传回来同意的信息。换句话说，建立连接并不仅仅是涉及到上层，还涉及到与下层协议动作的一些关联关系
...
HTTP1.1默认不关连接的意思是 保持TCP连接 继续发送HTTP请求
...
- 301 Moved Permanently: 请求的对象已经被永久转移了：新的URL在响应报文的Location首部行中指定；客户端软件自动用新的URL去获取对象
...
### 补充：郑烇老师讲解第八版第二章新增知识点  HTTP/2和HTTP/3简介
![Pasted image 20260728200726.png\|500](/img/user/accessory/Pasted%20image%2020260728200726.png)
服务器会设置允许的并行格式 一般是4
![Pasted image 20260728200906.png\|500](/img/user/accessory/Pasted%20image%2020260728200906.png)

![Pasted image 20260728200956.png\|500](/img/user/accessory/Pasted%20image%2020260728200956.png)

![Pasted image 20260728201211.png\|500](/img/user/accessory/Pasted%20image%2020260728201211.png)
![Pasted image 20260728201335.png\|500](/img/user/accessory/Pasted%20image%2020260728201335.png)
![Pasted image 20260728201416.png\|500](/img/user/accessory/Pasted%20image%2020260728201416.png)
![Pasted image 20260728201643.png\|500](/img/user/accessory/Pasted%20image%2020260728201643.png)
![Pasted image 20260728201856.png\|500](/img/user/accessory/Pasted%20image%2020260728201856.png)
![Pasted image 20260728201930.png\|500](/img/user/accessory/Pasted%20image%2020260728201930.png)
![Pasted image 20260728202124.png\|500](/img/user/accessory/Pasted%20image%2020260728202124.png)
![Pasted image 20260728202445.png\|500](/img/user/accessory/Pasted%20image%2020260728202445.png)
![Pasted image 20260728202716.png\|500](/img/user/accessory/Pasted%20image%2020260728202716.png)

![Pasted image 20260728202800.png\|300](/img/user/accessory/Pasted%20image%2020260728202800.png)
![Pasted image 20260728202948.png\|500](/img/user/accessory/Pasted%20image%2020260728202948.png)
![Pasted image 20260728203019.png\|300](/img/user/accessory/Pasted%20image%2020260728203019.png)
![Pasted image 20260728203147.png\|500](/img/user/accessory/Pasted%20image%2020260728203147.png)
![Pasted image 20260728203208.png\|500](/img/user/accessory/Pasted%20image%2020260728203208.png)
![Pasted image 20260728203245.png\|400](/img/user/accessory/Pasted%20image%2020260728203245.png)
![Pasted image 20260728203339.png\|500](/img/user/accessory/Pasted%20image%2020260728203339.png)
![Pasted image 20260728203403.png\|500](/img/user/accessory/Pasted%20image%2020260728203403.png)
![Pasted image 20260728203441.png\|450](/img/user/accessory/Pasted%20image%2020260728203441.png)
![Pasted image 20260728203558.png\|450](/img/user/accessory/Pasted%20image%2020260728203558.png)

![Pasted image 20260728203707.png\|450](/img/user/accessory/Pasted%20image%2020260728203707.png)
![Pasted image 20260728203912.png\|500](/img/user/accessory/Pasted%20image%2020260728203912.png)
![Pasted image 20260728203936.png\|450](/img/user/accessory/Pasted%20image%2020260728203936.png)
![Pasted image 20260728203956.png\|500](/img/user/accessory/Pasted%20image%2020260728203956.png)
