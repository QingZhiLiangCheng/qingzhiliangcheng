---
{"created":"2025-10-18T15:16","updated":"2026-03-22T14:23","dg-publish":true,"permalink":"/Computer Networking A Top-Down Approach/2.2 Web和HTTP/","dgPassFrontmatter":true,"noteIcon":"","dg-note-properties":{"created":"2025-10-18T15:16","updated":"2026-03-22T14:23"}}
---
...
### Web应用
Web是一个应用
Web页是由一些对象组成的，这些对象可以是HTML文件，可以使JPG图片，可以使音频文件等等，但是这些对象不是以对象自己的形式存在的，而是通过URL(统一资源定位符)对每个对象进行引用，URL包括访问协议，用户名，口令字，端口，目标文件等
