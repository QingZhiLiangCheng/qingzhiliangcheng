---
{"created":"2025-09-12T20:38","updated":"2026-03-17T14:35","dg-publish":true,"permalink":"/Computer Networking A Top-Down Approach/1.3 网络核心/","dgPassFrontmatter":true,"noteIcon":"","dg-note-properties":{"created":"2025-09-12T20:38","updated":"2026-03-17T14:35"}}
---
...
WDM是将两个节点间的波段分成一个一个小波段 本质上就是光频段的频分复用（FDM）
...
N个用户，链路带宽为1Mb/s，每个用户有10%的可能性活动，活跃时的带宽是100kb/s
...
$$
1-\sum^{10}_{n=0}C_{35}^np^n(1-p)^{35-n}=0.0004
$$
