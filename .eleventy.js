...
module.exports = function (eleventyConfig) {
    ...
    let markdownLib = markdownIt({
        ...
        .use(embedVideoPlugin)//Done[2025-08-16](QingZhiLiangCheng):增加video视频解析
    ...
    eleventyConfig.addPassthroughCopy("src/site/video");//Done[2025-08-16](QingZhiLiangCheng): url访问video
      ...
      .catch(() => {
        container.innerHTML = \`
          <div style="
            ...
            font-family: 'Segoe UI', 'PingFang SC', 'Helvetica Neue', sans-serif;
          ">
            <h2 style="margin-bottom: 0.5em;">⚠️ 视频加载失败</h2>
            <p style="font-size: 1.1rem;">可能是网络问题或服务器出错，请稍后再试。</p>
          </div>
        \`;
      });
...
`;
    ...
    md.core.ruler.after("inline", "video_embed", videoEmbedReplace);
}
